...
//    opacity: 0.3
    Row {
        ...
        ToolBtn {id: clear_tool; iconName: "003.png"; text: "clearrubbish"; showtext:qsTr("SysClear"); onSend: toolwidget.state = "Clear"}
        Rectangle {id: splitbar3; height: 38; width: 1; color: "#086794" }
        Rectangle {id: splitbar7; height: 38; width: 1; color: "#45a6d4" }
        ToolBtn {id: beauty_tool;iconName: "004.png";text: "systemset"; showtext:qsTr("Beautify"); onSend: toolwidget.state = "Beauty"}
