...
//    property int textIndent: 0
    ...
    property string itemFlag//1210 apt/soft标记
...
//    property string btn_flag: "one_key_scan"
//    property string itemFlag//1210 apt/soft标记
//    signal selectNum(bool check_status, string item_flag)   //作为子项checkbox，当状态改变时需要通过信号传给父项以进行个数统计
//    signal clicked
...
//    clip: true
//    onSelectedChanged: selected ? state = 'selected' : state = ''
//    onCheckbox_statusChanged: {//根据主checkbox传递的参数显示子checkbox的状态，如果主为true，则子全部为true;如果主为fasle，则子全部为false
//        console.log("aaaaaaaaaa");
////        console.log(container.checkbox_status);
//        checkbox.checked = container.checkbox_status;
//    }
...
//        id: checkbox
////        width: 30
//        checked: true//container.checkbox_status//
//        anchors.verticalCenter: parent.verticalCenter
//        anchors.left: parent.left
//        anchors.leftMargin: 30
////        onCheckedChanged: {
//        onClicked: {
//            //单个checkbox状态改变时，先将状态通过信号selectNumChanged()传递给BrowserCookies.qml
//            console.log("sub item cliced...");
//            console.log(checkbox.checked);
//            container.selectNum(checkbox.checked, container.itemFlag);
//            if (checkbox.checked) {
////                if (btn_flag == "apt_work") {
//                if(container.itemFlag == "apt") {
//                    var aptlist = systemdispatcher.get_apt_args();
