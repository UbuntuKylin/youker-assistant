...
//    property string scope_desc: qsTr("Tips: No support the Chinese path.")//提示：暂不支持中文路径。
//    property string btnFlag: "largestfile_work"//清理的标记：largestfile_work
//    property bool resultFlag: false//判断soft扫描后的实际内容是否为空，为空时为false，有内容时为true
//    property int fileNum//扫描后得到的apt的项目总数
...
//    property int arrow_show: 0//传递给CacheDelegate.qml是否显示伸缩图标，为1时显示，为0时隐藏
//    property bool expanded: false//传递给CacheDelegate.qml,觉得伸缩图标是扩展还是收缩
//    property bool maincheck: true
//    property bool showNum: false//决定扫描结果数是否显示
//    property bool fileEmpty: false//决定是否显示扫描内容为空的状态图
//    property int size: 0
//    property string directory: ""
//    ListModel { id: mainModel }
//    ListModel { id: subModel }
...
//        onAppendLargestContentToModel: {
//            //QString sizeValue, QString path
//            subModel.append({"itemTitle": sizeValue, "desc": path, "number": ""});
//            root.fileNum += 1;
//            systemdispatcher.set_largestfile_args(path);
//            console.log("---------");
//            console.log(sizeValue);
//            console.log(path);
//        }
//        onTellQMLLargestOver: {
//            mainModel.clear();
//            //清理路径为：   清理用户指定目录下的最大文件，节省磁盘空间。
//            mainModel.append({
//                             "mstatus": root.maincheck ? "true": "false",
...
//                root.showNum = false;
//                root.expanded = false;//伸缩箭头不扩展
//                root.arrow_show = 0;//伸缩箭头不显示
...
//                root.showNum = true;
//                root.expanded = true;//伸缩箭头扩展
//                root.arrow_show = 1;//伸缩箭头显示
...
//            }
//            scrollItem.height = (root.fileNum + 1) * 40;
//        }
//    }
...
//                //清理后重新扫描显示
//                root.flag = true;
//                sessiondispatcher.scan_of_large_qt(root.size, root.directory);
//            }
//        }
//    }
...
//                id: listView
//                width: parent.width
//                height: root.expanded ? (root.fileNum + 1) * 40 : 0
//                model: mainModel
//                delegate: FileDelegate{
//                    sub_num: root.fileNum
//                    sub_model:subModel
//                    btn_flag: root.btnFlag
//                    arrowFlag: "file"
//                    showNum: root.showNum
//                    arrow_display: root.arrow_show//为0时隐藏伸缩图标，为1时显示伸缩图标
//                    expanded: root.expanded//apt_expanded为true时，箭头向下，内容展开;apt_expanded为false时，箭头向上，内容收缩
//                    delegate_flag: false
////                    emptyTip: root.fileEmpty
