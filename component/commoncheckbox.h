...
#ifndef COMMONCHECKBOX_H
#define COMMONCHECKBOX_H
...
class CommonCheckBox : public QWidget
{
    Q_OBJECT
public:
    explicit CommonCheckBox(QWidget *parent = 0, const QString &picture= "");
    ~CommonCheckBox();
