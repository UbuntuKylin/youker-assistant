    ...
    :QWidget(parent)
{
    ...
    is_change = false;
    current_page = 1;
    tip_list<<QObject::tr("皮肤1")<<QObject::tr("皮肤2")<<QObject::tr("皮肤3")<<QObject::tr("皮肤4")<<QObject::tr("皮肤5")<<
           QObject::tr("皮肤6")<<QObject::tr("皮肤7")<<QObject::tr("皮肤8")<<QObject::tr("皮肤9")<<QObject::tr("皮肤10");
    this->initTitleBar();
...
void SkinsWidget::initTitleBar() {
    ...
    title_label->setText(QObject::tr("优客皮肤中心"));
...
void SkinsWidget::initBottomBar() {
    ...
    first_page_button->setText(QObject::tr("首页"));
    previous_page_button->setText(QObject::tr("上一页"));
    next_page_button->setText(QObject::tr("下一页"));
    last_page_button->setText(QObject::tr("末页"));
