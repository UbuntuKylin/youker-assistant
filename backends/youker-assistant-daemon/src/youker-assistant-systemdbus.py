...
if __name__ == '__main__':
    parser = optparse.OptionParser(prog="youker-assistant-system-daemon",
    ...
    from system_daemon import SystemDaemon
    print("The systemdbus server is running..........")
    dbus.mainloop.glib.DBusGMainLoop(set_as_default=True)
    mainloop = GObject.MainLoop()
    a = SystemDaemon(dbus.SystemBus(), mainloop)
