...
#ifndef KEYBOARDINFO_H
#define KEYBOARDINFO_H
...
enum KBI_INDEX{
    KEYBOARDINFO_TITLE,
    KEYBOARDINFO_INVALID,
    KEYBOARDINFO_DEVTYPE,
    KEYBOARDINFO_NAME,
    KEYBOARDINFO_DEVMODEL,
    KEYBOARDINFO_MANUFACTURER,
    KEYBOARDINFO_DEVADDR,
    KEYBOARDINFO_INTERFACE,
    KEYBOARDINFO_DRIVER,
};

class KeyboardInfo : public KABaseInfoPage
{
    Q_OBJECT
public:
    explicit KeyboardInfo(QWidget *parent = nullptr);
