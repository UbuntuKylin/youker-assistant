...
#ifndef VOICECARDINFO_H
#define VOICECARDINFO_H
...
enum VCI_INDEX{
    VOICECARDINFO_TITLE,
    VOICECARDINFO_INVALID,
    VOICECARDINFO_BUSADDR,
    VOICECARDINFO_DRIVE,
    VOICECARDINFO_MODEL,
    VOICECARDINFO_MANUFACTURER,
    VOICECARDINFO_NAME,
    VOICECARDINFO_CLOCK,
    VOICECARDINFO_BITWIDTH,
};

class VoiceCardInfo : public KABaseInfoPage
{
    Q_OBJECT
public:
    explicit VoiceCardInfo(QWidget *parent = nullptr);
